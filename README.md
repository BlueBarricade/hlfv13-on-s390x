# Hyperledger Fabric 1.3 on s309x server
...
- git clone https://github.com/BlueBarricade/hlfv13-on-s390x
- cd hlfv13-on-s390x
...
4. To find the files you'll need for this, `cd hlfv13-on-s390x/code/` and then run `ls` to see what is in the directory.
